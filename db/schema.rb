...
ActiveRecord::Schema.define(version: 20_210_523_214_511) do
  ...
  create_table 'classes', id: :integer, charset: 'utf8mb4', force: :cascade do |t|
    t.integer 'id_teachers_classes'
    t.integer 'week_day'
    t.string 'class', limit: 100, null: false
  end

  create_table 'classes_list', primary_key: 'id_class_list', id: :integer, charset: 'utf8mb4', force: :cascade do |t|
    t.integer 'id_classes'
    t.string 'key_word'
    t.timestamp 'class_date', default: -> { 'current_timestamp()' }, null: false
  end
